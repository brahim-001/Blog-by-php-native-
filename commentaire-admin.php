...
<body>
 ...
 ?>
    ...
    <h1 style="text-align: center; margin-top:50px;">Comments</h1>
    <div class="container">
        ...
        <table class="table pb-5">
            ...
            <tbody>
                ...
                <?php
        $affiche = $conn->prepare("SELECT * from commentaire");
        $affiche->execute();

        $resultat = $affiche->setFetchMode(PDO::FETCH_ASSOC);
        foreach ($affiche->fetchAll() as $key => $comment) :
        ?>
                <tr>
                    ...
                    <td>
                        <a href="delete_commentaire.php?id=<?php echo $comment["id_comment"] ?>&sourcepage=1"
