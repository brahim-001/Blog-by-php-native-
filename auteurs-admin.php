...
<body class="bg-light">
    ...
    <h1 style="text-align: center; margin-top:50px;">Writers</h1>


    <div class="container">
        <div class="mb-5 mt-3">
            Add a whriter <a type="button" class="btn btn-secondary btn-sm" href="auteursAdd.php"> Add</a>
        </div>
        <table class="table">
        ...
        ?>
                <tr>
                    <td> <?php echo $auteur["id_aut"] ?> </td>
                    <td> <?php echo $auteur["fullname"] ?> </td>
                    <td style="width: 300px"> <img src="uploads/<?php echo $auteur["avatar"] ?>" alt=""
                            style="width:30%"></td>
                    <td> <?php echo $auteur["email"] ?> </td>
                    <td><a type="button" class="btn btn-secondary"
                            href="auteursUpdate.php?id=<?php echo $auteur["id_aut"] ?>">update</a>

                        <a href="auteursDelete.php?id=<?php echo $auteur["id_aut"] ?>" type="button"
