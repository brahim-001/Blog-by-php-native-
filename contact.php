...
<body>
 ...
 ?>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight"
        style="background-image: url('https://www.a2ict.com/imgs/contact.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
            ...
            <div class="row block-9 no-gutters">
                <div class="col-lg-6 order-md-last d-flex">
                    ...
                    <form action="messageTrait.php" method="POST" nctype="multipart/form-data"
