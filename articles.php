...
<body>
    ...
    $affiche = $conn->prepare("SELECT * from article lIMIT 9");
    $affiche->execute();
    ...
    <div class="hero-wrap js-fullheight"
        style="background-image: url('https://www.tessi.eu/fr/wp-content/uploads/sites/2/2020/02/tessi-insights-ia-ok.png');"
    ...
    <section class="ftco-section bg-light" id="test">
        <div class="container">
            <div class="row d-flex">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a href="blog-single.php?id=<?php echo $article["id_article"]?>" class="block-20"
                            style="background-image: url('uploads/<?= $article["image"]?>');">
                        </a>
                        <div class="text p-4 float-right d-block">
                            <div class="topper d-flex align-items-center">
                                <div class="one py-2 pl-3 pr-1 align-self-stretch">

                                    <span class="mos"><?= $article["date"]?></span>
                                </div>
                            </div>
                            <h3 class="heading mb-3"><?php echo $article["title"] ?></h3>
                            <h6></h6>
                            <p><?php echo substr($article["contenu"], 0, 100) ?>...</p>
                            <p>
                                <a href="blog-single.php?id=<?php echo $article["id_article"]?>" class="btn-custom">
