                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="p-2 text-dark" href="article-admin.php">Articles</a>
            ...
            <div>
                ...
                <div class="form-group  mt-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value=" <?php echo $resultat["name"] ?> "
                            id="inputPassword4" name="nom">
                    </div>


                    <div>
                        <img src="uploads/<?php echo $resultat["image"] ?>" alt="thteejjet" style="width:300px">
                    </div>


                    <div class="form-group">
                        <label for="fichier">image</label>
                        <input type="file" class="form-control-file" name="image" id="fichier">
                    </div>

                </div>
                <button type="submit" name="submit" class="btn btn-primary mt-5">Check in</button>
        </form>
