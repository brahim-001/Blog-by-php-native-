        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="articles.php">Home <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span>Categories <i
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    <h2 class="mb-4">All of Categories</h2>
                </div>
            </div>
            <div class="row ftco-animate">
                <div class="col-md-12">
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        <?php
                          foreach ($affiche->fetchAll() as $key => $category) :
                        ?>

                        <div class="item">
                            <div class="testimony-wrap p-3">
                                <div class="text">
                                    <span class="position">
                                        <a href="category-article.php?id=<?php echo $category["id_cat"]?>">Voir
                                            tous les articles du caégorie</a>
                                    </span>

                                    <div class="d-flex align-items-center mt-4">
                                        <div class="user-img"
                                            style="background-image: url('uploads/<?= $category["image"]?>')"></div>
                                        <div class="pl-3">
                                            <p class="name"><a
                                                    href="category-article.php?id=<?php echo $category["id_cat"]?>"><?php echo $category["name"] ?></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
