...
<body class="bg-light">
    ...
    <h1 style="text-align: center; margin-top:50px;">Messages</h1>
    ...
    <div class="container">
        ...
        <table class="table" style="width:100%">
            ...
            <tbody>
                ...
                <?php
                 $affiche = $conn->prepare("SELECT * from message ");
                 $affiche->execute();
                 $resultat = $affiche->setFetchMode(PDO::FETCH_ASSOC);
                 foreach ($affiche->fetchAll() as $key => $message) :
                 ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="messageDelete.php?id=<?php echo $message["id"] ?>" type="button"
