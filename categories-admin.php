...
<body class="bg-light">
 ...
 ?>
    ...
    <h1 style="text-align: center; margin-top:50px;">Categories</h1>


    <div class="container">
        <div class="mb-5 mt-3">
            Add a category <a type="button" class="btn btn-secondary btn-sm" href="categoryAdd.php">Add</a>
        </div>
        <table class="table" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 300px"> <img src="uploads/<?php echo $category["image"] ?>" alt=""
                            style="width:30%">
                    </td>
                    <td><a type="button" class="btn btn-secondary"
                            href="categoryUpdate.php?id=<?php echo $category["id_cat"] ?>">update</a>

                        <a href="categoryDelete.php?id=<?php echo $category["id_cat"] ?>" type="button"
